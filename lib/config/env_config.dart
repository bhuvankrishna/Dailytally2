...
class EnvConfig {
  ...
  RemoteDataSourceType getRemoteSourceType() {
    final sourceTypeString = getString('REMOTE_SOURCE_TYPE', defaultValue: 'restApi');
  ...
  int get autoSyncIntervalMinutes => getInt('AUTO_SYNC_INTERVAL_MINUTES', defaultValue: 15);

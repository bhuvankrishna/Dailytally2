...
enum ReportPeriod { daily, weekly, monthly, quarterly }
...
class ReportService {
  ...
  Future<ReportData> getReportData(ReportPeriod period,
  ...
  Future<List<ReportData>> getHistoricalReports(
      ReportPeriod period, int count) async {
